...
import { 
  ...
  Menu, X, Ticket, Heart, CreditCard, Package, Upload
} from 'lucide-react';
...
const UserDashboardFixed = () => {
  ...
  const sidebarItems = [
    { id: 'create-event', label: 'create an event', icon: PlusCircle, path: '/dashboard/create-event' },
    { id: 'create-brief', label: 'create event brief', icon: FileText, path: '/dashboard/event-brief' },
    { section: 'DASHBOARDS' },
    ...
    { section: 'MAKE' },
    { id: 'create-event-make', label: 'Create Event', icon: PlusCircle, path: '/dashboard/create-event' },
    { id: 'event-brief', label: 'Event Brief', icon: FileText, path: '/dashboard/event-brief' },
    { id: 'gallery', label: 'Gallery', icon: Camera, path: '/dashboard/gallery' },
    { id: 'portfolio-upload', label: 'Portfolio Upload', icon: Upload, path: '/dashboard/portfolio-upload' },
    { id: 'payments', label: 'Payments', icon: DollarSign, path: '/dashboard/payments' },
    { id: 'contact-forms', label: 'Contact Forms', icon: MessageSquare, path: '/dashboard/contact-forms' },

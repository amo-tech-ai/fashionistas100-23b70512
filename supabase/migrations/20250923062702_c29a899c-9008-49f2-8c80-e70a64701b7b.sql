-- Final fix: Use proper operator classes for exclusion constraint

-- =====================================
-- 1. FIX VENUE BOOKING OVERLAP CONSTRAINT (PROPER OPERATOR CLASSES)
-- =====================================
...
-- Enable btree_gist extension for mixed index types
CREATE EXTENSION IF NOT EXISTS btree_gist;

-- Create proper overlap exclusion constraint with explicit operator classes
ALTER TABLE public.venue_bookings 

...
-- Based on comprehensive schema audit and linter results

-- =====================================
-- 1. FIX VENUE BOOKING OVERLAP CONSTRAINT
-- =====================================

-- Drop the problematic constraint that uses non-existent timerange()
ALTER TABLE public.venue_bookings 
DROP CONSTRAINT IF EXISTS no_venue_double_booking;

-- Add proper overlap constraint using date + time combination
ALTER TABLE public.venue_bookings 
...
-- =====================================
-- 4. ADD PERFORMANCE INDEXES FOR RLS
-- =====================================

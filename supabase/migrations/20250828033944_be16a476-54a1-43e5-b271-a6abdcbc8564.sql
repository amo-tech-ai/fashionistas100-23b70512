-- Insert venues for September 2025 events
INSERT INTO public.venues (venue_name, address, city, country, max_capacity, description, venue_type, status, slug) VALUES
('Centro de Convenciones Plaza Mayor', 'Calle 41 #55-80, Medellín', 'Medellín', 'Colombia', 2000, 'Centro de convenciones con sistema de iluminación profesional, audio de alta calidad, áreas de backstage amplias, lounges VIP y estacionamiento para 500 vehículos.', 'convention_center', 'active', 'centro-convenciones-plaza-mayor'),
('Hotel Intercontinental Medellín', 'Carrera 43A #7-50, El Poblado', 'Medellín', 'Colombia', 400, 'Hotel de lujo en El Poblado con salón de baile, terraza panorámica, servicio de valet y suites VIP para diseñadores.', 'hotel', 'active', 'hotel-intercontinental-medellin'),
('Ruta N - Centro de Innovación', 'Calle 67 #52-20, Medellín', 'Medellín', 'Colombia', 500, 'Centro de innovación tecnológica perfecto para conferencias y summits de sostenibilidad en la moda.', 'conference_center', 'active', 'ruta-n-centro-innovacion'),
('Parque El Poblado', 'Carrera 43A con Calle 7, El Poblado', 'Medellín', 'Colombia', 1000, 'Espacio al aire libre en El Poblado ideal para festivales de moda urbana y eventos comunitarios.', 'outdoor_space', 'active', 'parque-el-poblado'),
('Museo Casa de la Memoria', 'Carrera 51 #36-66, Buenos Aires', 'Medellín', 'Colombia', 250, 'Espacio cultural elegante perfecto para showcases de moda nupcial y eventos íntimos de alta costura.', 'museum', 'active', 'museo-casa-memoria');

-- Insert sample events for September 2025
INSERT INTO public.events (event_name, description, start_datetime, end_datetime, venue_id, organizer_id, status) VALUES
('Medellín Fashion Week Otoño 2025', 'La semana de la moda más prestigiosa de Colombia presenta colecciones de otoño/invierno 2026 con 45+ diseñadores colombianos e internacionales enfocados en moda sostenible y herencia cultural.', '2025-09-18 18:00:00+00', '2025-09-25 23:00:00+00', (SELECT id FROM venues WHERE slug = 'centro-convenciones-plaza-mayor'), '00000000-0000-0000-0000-000000000001', 'published'),
('Noches de Alta Costura Paisa', 'Gala exclusiva de alta costura celebrando el talento colombiano con diseñadores emergentes y establecidos, presentando colecciones de lujo inspiradas en la cultura antioqueña.', '2025-09-12 19:00:00+00', '2025-09-12 23:30:00+00', (SELECT id FROM venues WHERE slug = 'hotel-intercontinental-medellin'), '00000000-0000-0000-0000-000000000001', 'published'),
('Cumbre de Moda Sostenible Medellín', 'Cumbre de dos días enfocada en innovación sostenible en la industria de la moda, presentando tecnologías eco-amigables, textiles orgánicos y prácticas de producción responsable.', '2025-09-05 09:00:00+00', '2025-09-06 18:00:00+00', (SELECT id FROM venues WHERE slug = 'ruta-n-centro-innovacion'), '00000000-0000-0000-0000-000000000001', 'published'),
('Festival de Moda Urbana El Poblado', 'Festival de fin de semana celebrando la moda urbana paisa con marcas emergentes, vintage local, y colaboraciones de street art. Incluye talleres de upcycling y música en vivo.', '2025-09-28 10:00:00+00', '2025-09-29 22:00:00+00', (SELECT id FROM venues WHERE slug = 'parque-el-poblado'), '00000000-0000-0000-0000-000000000001', 'published'),
('Medellín Bridal Fashion Experience', 'Presentación exclusiva de colecciones nupciales y vestidos de gala de diseñadores colombianos, con enfoques en tradiciones regionales y elegancia contemporánea.', '2025-09-14 15:00:00+00', '2025-09-15 20:00:00+00', (SELECT id FROM venues WHERE slug = 'museo-casa-memoria'), '00000000-0000-0000-0000-000000000001', 'published');

-- Insert tickets for Medellín Fashion Week

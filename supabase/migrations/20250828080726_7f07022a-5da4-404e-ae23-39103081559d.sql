-- First create sample user profiles that designers can link to
INSERT INTO public.profiles (id, email, full_name, bio, profile_visibility, created_at, updated_at, is_active)
SELECT 
  '00000000-0000-0000-0000-000000000001'::uuid,
  'alessandro@rossicouture.com',
  'Alessandro Rossi',
  'Master of Italian haute couture',
  'public',
  now(),
  now(),
  true
WHERE NOT EXISTS (SELECT 1 FROM public.profiles WHERE id = '00000000-0000-0000-0000-000000000001'::uuid);

INSERT INTO public.profiles (id, email, full_name, bio, profile_visibility, created_at, updated_at, is_active)
SELECT 
  '00000000-0000-0000-0000-000000000002'::uuid,
  'sofia@chenstudios.com',
  'Sofia Chen',
  ...
  now(),
  true
WHERE NOT EXISTS (SELECT 1 FROM public.profiles WHERE id = '00000000-0000-0000-0000-000000000002'::uuid);

INSERT INTO public.profiles (id, email, full_name, bio, profile_visibility, created_at, updated_at, is_active)
SELECT 
  '00000000-0000-0000-0000-000000000003'::uuid,
  'maya@laurentparis.com',
  'Maya Laurent',
  'Parisian elegance designer',
  'public',
  now(),
  now(),
  true
WHERE NOT EXISTS (SELECT 1 FROM public.profiles WHERE id = '00000000-0000-0000-0000-000000000003'::uuid);

-- Now create the verified designer profiles

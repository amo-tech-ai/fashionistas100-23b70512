-- Create sample organizer profiles first, then populate September 2025 events
INSERT INTO public.profiles (id, full_name, email, bio, city, country, profile_visibility, is_active) VALUES
('00000000-0000-0000-0000-000000000001', 'Medellín Fashion Events', 'organizer@medellinfashion.co', 'Organizador principal de eventos de moda en Medellín', 'Medellín', 'Colombia', 'public', true);
...
-- Events
INSERT INTO public.events (event_name, description, start_datetime, end_datetime, venue_id, organizer_id, status)
VALUES

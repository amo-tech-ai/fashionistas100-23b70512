-- Make organizer_id nullable temporarily to insert sample data, then add the Medellín events

-- 1. Modify events table to allow null organizer_id 
...
-- 3. Insert events (organizer_id will be null for sample data)
